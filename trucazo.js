...
// si cantas truco no podes cantar envido
...
if(cartaEnemigoPrimera.innerHTML != (cartaEnemigo1.numero + cartaEnemigo1.palo)){
    ...
    desvelarCartaEnemigo2()
}
else if(cartaEnemigoTercera.innerHTML != (cartaEnemigo3.numero + cartaEnemigo3.palo)){desvelarCartaEnemigo3()}
else{
